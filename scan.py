...
def main():
	...
	print wait+"\nWelcome to Admin & Shell Finder - Powered by UnderTerror@AnarchoXploit"
	website_url = raw_input("\n\nEnter URL to scan Bang : ")
	...
	try:
		...
		print positive+"Connected! Begining to scan for Admin Login & ShellsBackdoor.."
